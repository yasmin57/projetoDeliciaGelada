                ...
                <div class="conteudo center back_goiaba">
                    <table class="curiosidades_table">
                        <tr>
                            ...
                            <td class="curiosidades_txt fonte" id="curiosidades_txt1">
                ...
                <div class="conteudo center back_green">
                    <table class="curiosidades_table">
                        <tr>
                            ...
                            <td class="curiosidades_txt fonte" id="curiosidades_txt2">
                ...
                <div class="conteudo center back_goiaba">
                    <table class="curiosidades_table">
                        <tr>
                            ...
                            <td class="curiosidades_txt fonte" id="curiosidades_txt3">
